...
<html>
    ...
    <body>
        ...
        <div class="corps">
            ...
            <h2 class="titrepage">Liste des clients</h2>
            <form class="recherche">
                <input type="search" name="Rcommande" value="Rechercher un client" class="zonerecherche"> <button type="submit" class="btnrecherche"><i class="fa-solid fa-magnifying-glass fa-xl iconerecherche"></i></button>
            </form>

        </div>

        <div class="listeclient">
            <c:forEach items="${clientListe}" var="clientliste">
                <div class="listecl">
                        <div class="clientcarac">
                            <p class="nomclientliste"> <c:out value="${clientliste.nom}" /> </p>
                            <p class="nomclientliste"> <c:out value="${clientliste.adresse}" /> </p>
                            <p class="nbrcommandeclient">Nombre de commande: 2 </p>
                        </div>
                    <!-- <form action="" method="post">
                        <button type="submit" class="btnhisto">Historique des commandes</button>
                    </form>-->
                </div>
            </c:forEach>
        </div>
        ...
        <div class="btnbas">
            <button class="btnajouterarticle" onclick="openForm()">Ajouter un article</button>
        </div>

        <div class="ajouter-popup">
            <div class="form-popup" id="popupForm">
                <form action="ClientsControleur" method="post" class="ppa">
                    <div class="entetepupajouter">
                        <p class="creationpiece">Créer un client</p>
                        <a class="quit" onclick="closeForm()"><i class="fa-solid fa-xmark"></i></a>
                    </div>

                    <div class="detailpièce">
                        <p class="nompièce">Nom client : <input type="text" name="nom" class="inputajouter"></p>
                        <p class="refpièce">Adresse : <input type="text" name="adresse" class="inputajouter"></p>
