...
int main(int argc, char *argv[]) {
  ...
  //Timing variable : 
  double start_time_scatter, end_time_scatter, start_time_reduce, end_time_reduce, start_time_computation, end_time_computation;
  ...
  if (myrank == 0) {
    ...
    printf("Cost of double Scatter : %fs\n", end_time_scatter - start_time_scatter);
    printf("Cost of Reduce : %fs\n", end_time_reduce - start_time_reduce);
    printf("Cost of communication : %fs \n\n", (end_time_scatter - start_time_scatter) + (end_time_reduce - start_time_reduce)); 
    
    printf("Cost of computation : %fs \n", (end_time_computation - start_time_computation) - ((end_time_scatter - start_time_scatter) + (end_time_reduce - start_time_reduce)));
